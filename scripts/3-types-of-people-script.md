# 3 Types of People You Need in Your Corner
## Video Script — Final Draft
### Duration Target: 2:45–3:00 | Voice: Josh (ElevenLabs) | Style: Cinematic Dark + Kinetic Text

---

## SCENE 1 — HOOK (0:00–0:12)
**[Visual: Dark particle field, floating geometric nodes connecting — text fades in with shimmer]**

**NARRATOR:**
"In a world that's changing faster than ever... the most dangerous thing you can do... is stay the same. Curiosity isn't optional anymore. It's your competitive edge. And the people around you? They either sharpen that edge... or dull it. Here are the 3 types of people you need in your corner."

**[Kinetic text punch: "CURIOSITY IS YOUR EDGE" — gold shimmer, then dissolves]**

---

## SCENE 2 — THE BELIEVER (0:12–0:52)
**[Visual: Mesh gradient background shifting cyan-to-deep-blue, glassmorphism card slides in with spring animation. Icon: glowing beacon/lighthouse]**
...
**[Kinetic text: "SHARE YOUR GOALS" — cyan glow, spring entrance]**

---

## SCENE 3 — THE PEER (0:52–1:32)
**[Visual: Particle nodes forming a parallel path — two paths running side by side. Background shifts to deep purple-blue gradient. Glassmorphism card with amber/gold accents]**
...
**[Kinetic text: "PROXIMITY IS THE PROGRAM" — amber/gold pulse]**

---

## SCENE 4 — THE COACH (1:32–2:18)
**[Visual: Dark scene with spotlight effect — volumetric light rays. Single glassmorphism card, orange accent border. Icon: compass/mirror]**
...
**[Kinetic text: "FILTER FOR TRUTH" — orange glow, fade-in]**

---

## SCENE 5 — THE BRIDGE: AI SKILLS (2:18–2:42)
...
**[Kinetic text sequence: "CURIOSITY" (cyan) → "LEARNING" (gold) → "ADAPTABILITY" (orange) — each word springs in then holds]**

---

## SCENE 6 — CTA + CLOSE (2:42–2:55)
...
### Color Palette (from scottmagnacca.com)
- Background: #0a0e1a (deep navy/charcoal)
- Primary accent: #00d4ff (cyan/teal)
- Secondary accent: #f5a623 (gold/amber)
- Tertiary accent: #ff6b35 (warm orange)
- Card background: rgba(255, 255, 255, 0.05) with backdrop-blur
- Card border: rgba(255, 255, 255, 0.1)
- Text: #ffffff (primary), #a0aec0 (secondary)

### Typography
- Headlines: Bold, large — spring entrance animations
- Body/narration support: Clean sans-serif, fade-in
- Kinetic text: Extra bold, glow effect matching accent color of scene

### Estimated Word Count: ~430 words
### Estimated Duration at conversational pace: ~2:50

### Audio
- Voice: Josh (ElevenLabs, eleven_turbo_v2_5)
- Pacing: Warm, conversational, with natural pauses between sections
- No background music (can be added later)
